...
from .html_image_utils import replace_inline_table_images, save_span_image_if_needed
from .office_magic_model import MagicModel
from .office_enum_class import BlockType
...
def result_to_middle_json(model_output_blocks_list, image_writer):
    middle_json = {"pdf_info": [], "_backend":"office"}
